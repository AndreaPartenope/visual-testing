...
exports.config = {
    ...
    // commands. Instead, they hook themselves up into the test process.'chromedriver',
    services:
        [['selenium-standalone'], ['image-comparison',
            // The options
            {
                // Some options, see the docs for more
                baselineFolder: join(process.cwd(), './test/screenshots/baseline'),
                formatImageName: '{tag}-{logName}-{width}x{height}',
                screenshotPath: join(process.cwd(), './test/screenshots/'),
